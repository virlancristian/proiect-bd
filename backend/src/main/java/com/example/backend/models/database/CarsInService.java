...
public class CarsInService {
    ...
    public CarsInService(int id, int carOwner, String brand_Name, String model_Name, int year_of_fabrication, float engine_Size, String fuel, int horse_Power, Integer Assigned_Service_Location) {
        this.CarID = id;
        Car_Owner = carOwner;
